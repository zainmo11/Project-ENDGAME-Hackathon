...
const AIReportModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
        ...
        {step !== 'done' ? (
          ...
          <>
            ...
            <div className="bg-slate-50 p-4 border-t border-slate-200 flex justify-end gap-3">
              ...
              <button onClick={onClose} className="px-6 py-2 bg-rology-500 hover:bg-rology-400 text-white font-bold rounded shadow-lg shadow-blue-500/20 flex items-center gap-2">
